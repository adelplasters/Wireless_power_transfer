...
classdef Square_Shaped_PCB
    ...
    methods 
    function [coilobj, omega] = Square_Shaped_PCB(Ts,T,n,S,W,f,din,dout, shape)
        ...
        fself = 1/(2*pi*sqrt(coilobj.L*coilobj.CP)); %self resonant frequency
